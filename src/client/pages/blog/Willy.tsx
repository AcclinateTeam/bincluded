            ...
            <section className="singBlog hero" style={{ height: `600px` }}>
                ...
                <div className="callout">
                    <div className="calltext">
                        ...
                        <p>Willy Etheridge - Voices From Our Community</p>
                    </div>
                </div>
            </section>
            ...
            <section className="breadcrumbs">
                <div className="container">
                    <div className="six columns offset-by-two bread">
                        <a href="/">Home</a> {'>'} <a href="/blog">Stories</a> {'>'} Willy Etheridge - Voices From Our Community
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="six columns offset-by-two">
                        <div className="storie">
                            <h2>Willy Etheridge</h2>
                            <h4>Voices From Our Community</h4>
                            <iframe width="100%" height="550px" src="https://www.youtube.com/embed/jHiG-BNkBNs" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        </div>
                    </div>
                    <div className="six columns offset-by-two">
                        <div className="text">
                            ...
                            Willy Etheridge is sharing his story in order to encourage others to be vaccinated.
                            </p>
                        </div>
                    </div>
