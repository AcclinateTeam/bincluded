    ...
    return (
        <footer>
            ...
            <svg viewBox="0 0 1440 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_179_768)">
                    ...
                    <g mask="url(#mask0_179_768)">
                        <g filter="url(#filter0_f_179_768)">
                            <path d="M-128.926 367.554L102.148 318.673L172.068 429.958L-44.6838 501.631L-128.926 367.554Z" fill="#6AE0FD" fill-opacity="0.24" />
                        </g>
                        <g filter="url(#filter1_f_179_768)">
                            <path d="M1273.39 140.247L1504.46 91.3661L1574.38 202.651L1357.63 274.324L1273.39 140.247Z" fill="url(#paint0_linear_179_768)" fill-opacity="0.1" />
                        </g>
                    </g>
                ...
                <defs>
                    <filter id="filter0_f_179_768" x="-408.926" y="38.6733" width="860.994" height="742.958" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="140" result="effect1_foregroundBlur_179_768" />
                    </filter>
                    <filter id="filter1_f_179_768" x="993.388" y="-188.634" width="860.994" height="742.958" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="140" result="effect1_foregroundBlur_179_768" />
                    </filter>
                    <linearGradient id="paint0_linear_179_768" x1="1388.92" y1="115.806" x2="1419.68" y2="261.198" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#D52A56" />
                        <stop offset="0.0001" stop-color="#D52A56" />
                        <stop offset="1" stop-color="#F98B27" />
                    </linearGradient>
                    <clipPath id="clip0_179_768">
