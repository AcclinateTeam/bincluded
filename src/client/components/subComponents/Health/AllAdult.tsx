...
const AllAdult = () =>
{
    return (
        <>
                ...
                <a href="http://joinoben.com" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <p>Individuals from underserved communities who are dealing with hypertension, heart disease, etc.</p>
                            <a href="http://joinoben.com" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://healthopx.com" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <p>HealthOpX is a software platform that partners community-based organizations and home care
                                ...
                                at-risk patients.</p>
                            <h2>Who Will Benefit</h2>
                            <p>HealthOpX offers operations software to community-based organizations so they can effectively carry out their own programs and work with government and health entities.</p>
                            <a href="https://healthopx.com" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>

            <ResPartner title="TruDiary" image="trudiary.png" description="TruDiary provides culturally relevant value-based care to Black and Brown maternal patients in
                                                                ...
                                                                health, lactation services and transportation." benefit="Mothers seeking quality prenatal and postpartum care from an energized team of maternal health advocates. " url="http://trudiary.com" />
            ...
            <ResPartner title="Kaya" image="kaya.png" description="Kaya offers virtual mental health groups connecting employees from different companies
                                                                ...
                                                                journeys." benefit="Employees looking to connect and share mental health experiences with peers from different companies." url="http://joinkaya.com" />

            <ResPartner title="PeakMind" image="peakmind.jpg" description="Peak Mind’s mental well-being platform addresses the $1.1T problem of work-related stress,
                                                                ...
                                                                be influenced by well-being nudges and action steps." benefit="Businesses interested in providing mental health services to their teams/employees." url="http://peakmindllc.com" />

            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://christhealthcenter.org/new-patients/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://christhealthcenter.org/new-patients/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.cahabamedicalcare.com/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.cahabamedicalcare.com/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.mpowerministries.org/health-center/#.YVcS1FrMLC8" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.mpowerministries.org/health-center/#.YVcS1FrMLC8" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.feedingal.org/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.feedingal.org/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.birminghamal.gov/community-development/community-resource-services-division/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.birminghamal.gov/community-development/community-resource-services-division/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.uwaaa.org/greatdiet/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.uwaaa.org/greatdiet/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://www.crisiscenterbham.org/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://www.crisiscenterbham.org/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://gracekleincommunity.com/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://gracekleincommunity.com/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://mowjeffco.org/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://mowjeffco.org/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
            ...
            {/* NEW ROW */}
            <div className="third columns">
                <a href="https://m4a.org/" target="_blank" rel="noopener noreferrer">
                    <div className="panes">
                        ...
                        <div className="pane">
                            ...
                            <a href="https://m4a.org/" target="_blank" rel="noopener noreferrer">Read More <FontAwesomeIcon className="readmo" icon="arrow-right" /></a>
                        </div>
                    </div>
                </a>
            </div>
