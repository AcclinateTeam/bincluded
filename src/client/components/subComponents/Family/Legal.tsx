...
const Legal = () =>
{
    return (
        <>
            ...
            <ResPartner title="Legal Aid Society of Birmingham" image="lasob.png" description="We are court-appointed attorneys assisting people who need legal representation." benefit="Anyone in need of legal representation from a court appointed attorney" url="https://www.legalaidbirmingham.com/"/>
